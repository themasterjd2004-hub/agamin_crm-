...
# Import your models
from crm.models import Request, CrmEmail  # Add other models as needed

urlpatterns = [
    path('', crm_site.urls),

    # Data addition endpoints
    path(
        'add/<str:model_name>/',
        staff_member_required(CreateView.as_view(
            template_name='crm/generic_add_form.html',
            success_url='/'
        )),
        name='generic_add'
    ),
    ...
    path(
        'edit/<str:model_name>/<int:pk>/',
        staff_member_required(UpdateView.as_view(
            template_name='crm/generic_edit_form.html',
            success_url='/'
        )),
        name='generic_edit'
    ),
    ...
    path('export-objects/', staff_member_required(export_objects_view), name="export_objects"),
    path('create-email/<int:object_id>', staff_member_required(create_email), name='create_email'),
